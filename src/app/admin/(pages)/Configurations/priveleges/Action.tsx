...
import { PenBox, Trash } from "lucide-react"; // Import Trash icon for delete action
...
interface ActionButtonProps {
    id: string; 
    status: number; 
    onDelete: number; // default is 0, when toggled should change to 1 
    refreshData: () => void; // Refresh data prop
}
