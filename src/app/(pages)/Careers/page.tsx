                        ...
                        <div className="flex flex-wrap items-center pb-12">
                            <div className="md:w-1/2 lg:w-2/3 w-full xl:pr-20 md:pr-6">
                                <div className="py-2 text-color">
                                    <h1 className="text-2xl lg:text-4xl md:leading-snug tracking-tighter f-f-l font-black">Join Our Team: Drive with Us</h1>
                                    <h2 className="text-lg lg:text-xl lg:leading-7 md:leading-10 f-f-r py-4 md:py-8">At Tranzbook, we are dedicated to delivering excellence in logistics. Join our team of skilled drivers and experience the thrill of the open road while helping to move cargo efficiently.</h2>
                ...
                <div className="pb-32 pt-16">
                    <div className="mx-auto">
                        <div className="flex flex-wrap flex-row-reverse items-center">
                            ...
                            <div className="lg:w-1/3 md:w-1/2 w-full relative h-96 flex items-end justify-center">
                                <Image className="absolute w-full h-full inset-0 object-cover object-center rounded-md" src={CargoDriver} alt="" />
                                <div className="relative z-10 p-4 bg-white shadow rounded mx-auto w-9/12 -mb-20">
                                    <h4 className="text-gray-800 font-normal text-md leading-4 tracking-normal mb-2">Cargo Truck Specialist</h4>
                                    <p className="text-gray-600 text-xs leading-3 font-normal">Join Our Team Today</p>
                                    <div className="mt-4 flex items-center">
                                        ...
                                        <p className="ml-1 text-sm text-gray-800 leading-3 tracking-normal font-normal">Tranzbook Logistics</p>
                                    </div>
                                    <div className="mt-3 flex items-center">
                                        ...
                                        <p className="ml-1 text-sm text-gray-800 leading-3 tracking-normal font-normal">Competitive Salary</p>
                                    </div>
